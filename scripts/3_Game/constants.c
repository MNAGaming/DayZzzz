...
const int 	STAMINA_DRAIN_STANDING_SPRINT_PER_SEC = 2.5; //in units (how much sprint depletes stamina)
const int 	STAMINA_DRAIN_CROUCHED_SPRINT_PER_SEC = 0.5; //in units (how much sprint in crouch depletes stamina)
const int 	STAMINA_DRAIN_PRONE_SPRINT_PER_SEC = 1.5; //in units (how much sprint in prone depletes stamina)
const int	STAMINA_DRAIN_SWIM_FAST_PER_SEC = 3.5; //in units (how much fast swimming depletes stamina)
const int	STAMINA_DRAIN_LADDER_FAST_PER_SEC = 5; //in units (how much fast ladder climb depletes stamina)

const float	STAMINA_DRAIN_HOLD_BREATH = 0.1; //in units (how much holding breath depletes stamina)
const float	STAMINA_DRAIN_JUMP = 10;		// in units (how much jumping depletes stamina)
const float	STAMINA_DRAIN_MELEE_LIGHT = 2.5; //in units (how much light melee punch depletes stamina)
const float	STAMINA_DRAIN_MELEE_HEAVY = 10; //in units (how much heavy melee punch depletes stamina)
const float	STAMINA_DRAIN_MELEE_EVADE = 4; // in units (how much evade depletes stamina)
	
const int 	STAMINA_GAIN_JOG_PER_SEC = 3; //in units (how much of stamina units is gained while jogging)
const int 	STAMINA_GAIN_WALK_PER_SEC = 5; //in units (how much of stamina units is gained while walking)
const int 	STAMINA_GAIN_IDLE_PER_SEC = 6; //in units (how much of stamina units is gained while iddling)
const int	STAMINA_GAIN_SWIM_PER_SEC = 2; //in units (how much of stamina units is gained while slowly swim)
const int	STAMINA_GAIN_LADDER_PER_SEC = 2; //in units (how much of stamina units is gained while slowly swim)
