 ...
 */
	...
	//following changes amended 2018-11-14 based on guidance from here: https://www.reddit.com/r/dayz/comments/9hb2ka/dayz_server_how_to_disable_stamina
const int 	STAMINA_DRAIN_STANDING_SPRINT_PER_SEC = 0; //5; //in units (how much sprint depletes stamina)
...
const float	STAMINA_DRAIN_HOLD_BREATH = 0; //0.2; //in units (how much holding breath depletes stamina)
const float	STAMINA_DRAIN_JUMP = 0; //20;		// in units (how much jumping depletes stamina)
const float	STAMINA_DRAIN_MELEE_LIGHT = 0; //5; //in units (how much light melee punch depletes stamina)
const float	STAMINA_DRAIN_MELEE_HEAVY = 0; //20; //in units (how much heavy melee punch depletes stamina)
const float	STAMINA_DRAIN_MELEE_EVADE = 0; //8; // in units (how much evade depletes stamina)
